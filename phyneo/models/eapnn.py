...
# Keep placeholders for legacy compatibility if needed
class FeatureExtractor(nn.Module):
    """Legacy placeholder. Use EAPNNForce._compute_internal instead."""
    def setup(self): pass
    def __call__(self, *args, **kwargs): raise NotImplementedError("Legacy FeatureExtractor removed. Use EAPNNForce.")

class NeuralNetwork(nn.Module):
    """Legacy placeholder. Use EAPNNForce.mlp instead."""
    def setup(self): pass
    def __call__(self, *args, **kwargs): raise NotImplementedError("Legacy NeuralNetwork removed. Use EAPNNForce.")
